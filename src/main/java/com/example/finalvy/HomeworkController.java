...
public class HomeworkController extends Demo {
    ...
    private void initialize() {
        ...
        if(list.isEmpty()){
            //if the list from Demo is not set, check it and set if it's empty
            setList();
        }
        ...
        //initialized in Demo class by order from student
